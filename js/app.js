...
(function() {
  ...
  __weatherly();
  // Automatically updating the weather in every 2 minutes (total 720 API calls a day)
  // Maximum 1000 calls per day is allowed
  window.setInterval(__weatherly, 120000);
